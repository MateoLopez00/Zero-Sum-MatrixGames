...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.78\textwidth]{figures/section3_bilateral_n20.png}
  ...
  \caption{Bilateral-learning extension. Solid curves show adaptive learner pairs, while dashed curves keep the original adversarial-column reference.}
  \label{fig:bilateral}
\end{figure}
